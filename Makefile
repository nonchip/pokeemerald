...
ASFLAGS := -mcpu=arm7tdmi --defsym MODERN=$(MODERN) --defsym NONCHIP_HACK=$(NONCHIP_HACK)
...
CPPFLAGS := -iquote include -iquote $(GFLIB_SUBDIR) -Wno-trigraphs -DMODERN=$(MODERN) -DNONCHIP_HACK=$(NONCHIP_HACK)
ifeq ($(MODERN),0)
